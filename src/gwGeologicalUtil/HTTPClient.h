...
namespace gwUtil
{
	 ...
	 */
	class GWGEOLOGICALUTIL_EXPORT ProxySettings
	{
	public:
	 ...
	 */
	class GWGEOLOGICALUTIL_EXPORT HTTPRequest
	{
	public:
	 ...
	 */
	class GWGEOLOGICALUTIL_EXPORT HTTPResponse
	{
	public:
		enum Code {
			NONE = 0,
	 ...
	 */
	struct GWGEOLOGICALUTIL_EXPORT URLRewriter : public osg::Referenced
	{
	 ...
	 */
	struct GWGEOLOGICALUTIL_EXPORT CurlConfigHandler : public osg::Referenced
	{
	 ...
	 */
	class GWGEOLOGICALUTIL_EXPORT HTTPClient
	{
	public:
		/**
