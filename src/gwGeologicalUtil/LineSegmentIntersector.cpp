...
osgUtil::Intersector* LineSegmentIntersector::clone(osgUtil::IntersectionVisitor& iv)
{
...
osg::Matrix LineSegmentIntersector::getTransformation(osgUtil::IntersectionVisitor& iv, CoordinateFrame cf)
{
	osg::Matrix matrix;
	switch (cf)
	{
