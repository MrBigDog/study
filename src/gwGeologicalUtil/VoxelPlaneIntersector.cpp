...
namespace gwUtil
{
	namespace VoxelPlaneIntersectorUtils
	{
	...
	void PlaneIntersector::intersect(osgUtil::IntersectionVisitor& iv, osg::Drawable* drawable)
	{
		...
		osg::TriangleFunctor<VoxelPlaneIntersectorUtils::TriangleIntersector> ti;
		...
		if (ti._hit)
		{
			...
			for (VoxelPlaneIntersectorUtils::PolylineConnector::PolylineList::iterator pitr = ti._polylineConnector._polylines.begin();
				...
				++pitr)
			{
				...
				for (VoxelPlaneIntersectorUtils::RefPolyline::Polyline::iterator vitr = (*pitr)->_polyline.begin();
