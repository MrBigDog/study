#ifndef GWGEOLOGICAL_IMAGEUTILS_H
#define GWGEOLOGICAL_IMAGEUTILS_H 1
...
namespace gwUtil
{
	class GWGEOLOGICALUTIL_EXPORT ImageUtils
	{
	public:
		/**
		 * Clones an image.
		 ...
		 */
		class GWGEOLOGICALUTIL_EXPORT PixelReader
		{
		public:
			/**
		 ...
		 */
		class GWGEOLOGICALUTIL_EXPORT PixelWriter
		{
		public:
			/**
	...
	class GWGEOLOGICALUTIL_EXPORT TextureAndImageVisitor : public osg::NodeVisitor
	{
	public:
...
#endif //GWGEOLOGICAL_IMAGEUTILS_H
