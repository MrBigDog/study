#ifndef GWGEOLOGICALUTIL_NODE_UTILS_H
#define GWGEOLOGICALUTIL_NODE_UTILS_H 1
...
namespace gwUtil
{
	 ...
	 */
	class GWGEOLOGICALUTIL_EXPORT PagedLODWithNodeOperations : public osg::PagedLOD
	{
	public:
	 ...
	 * not be affected.)
	 */
	class GWGEOLOGICALUTIL_EXPORT RemoveEmptyGroupsVisitor : public osg::NodeVisitor
	{
	public:
	 ...
	 * in a scene graph.
	 */
	class GWGEOLOGICALUTIL_EXPORT PrimitiveSetTypeCounter : public osg::NodeVisitor
	{
	public:
	 ...
	 */
	class GWGEOLOGICALUTIL_EXPORT ObserverGroup : public osg::Group
	{
	public:
		ObserverGroup();
