#ifndef GWGEOLOGICALUTIL_IOTYPES_H
#define GWGEOLOGICALUTIL_IOTYPES_H 1
...
namespace gwUtil
{
	 ...
	 */
	class GWGEOLOGICALUTIL_EXPORT StringObject : public osg::Object
	{
	public:
		StringObject();
		...
		META_Object(gwUtil, StringObject);
	...
	*/
	struct GWGEOLOGICALUTIL_EXPORT IOMetadata
	{
	...
	*/
	struct GWGEOLOGICALUTIL_EXPORT ReadResult
	{
		/** Read result codes. */
		enum Code
		{
	...
	//--------------------------------------------------------------------
		 ...
		 */
	class GWGEOLOGICALUTIL_EXPORT URIReadCallback : public osg::Referenced
	{
	public:
		enum CachingSupport
		{
	...
	public:
		...
		virtual gwUtil::ReadResult readObject(const std::string& uri, const osgDB::Options* options) {
			return gwUtil::ReadResult::RESULT_NOT_IMPLEMENTED;
		}

		/** Override the readNode() implementation */
		virtual gwUtil::ReadResult readNode(const std::string& uri, const osgDB::Options* options) {
			return gwUtil::ReadResult::RESULT_NOT_IMPLEMENTED;
		}

		/** Override the readImage() implementation */
		virtual gwUtil::ReadResult readImage(const std::string& uri, const osgDB::Options* options) {
			return gwUtil::ReadResult::RESULT_NOT_IMPLEMENTED;
		}

		/** Override the readString() implementation */
		virtual gwUtil::ReadResult readString(const std::string& uri, const osgDB::Options* options) {
			return gwUtil::ReadResult::RESULT_NOT_IMPLEMENTED;
		}

		/** Override the readConfig() implementation */
		virtual gwUtil::ReadResult readConfig(const std::string& uri, const osgDB::Options* options) {
			return gwUtil::ReadResult::RESULT_NOT_IMPLEMENTED;
		}
...
#endif // GWGEOLOGICALUTIL_IOTYPES_H
