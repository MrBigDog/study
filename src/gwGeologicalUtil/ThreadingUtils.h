#ifndef GWGEOLOGICALUTIL_THREADING_UTILS_H
#define GWGEOLOGICALUTIL_THREADING_UTILS_H 1
...
namespace gwUtil 
{
	namespace Threading
	{
		 ...
		 */
		extern GWGEOLOGICALUTIL_EXPORT unsigned getCurrentThreadId();
...
} // namepsace gwUtil::Threading


#endif // GWGEOLOGICALUTIL_THREADING_UTILS_H
