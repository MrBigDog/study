#ifndef GWGEOLOGICALUTIL_URI
#define GWGEOLOGICALUTIL_URI 1
...
namespace gwUtil
{
	 ...
	 */
	class GWGEOLOGICALUTIL_EXPORT URIContext
	{
	public:
	...
	//--------------------------------------------------------------------
		 ...
		 */
	class GWGEOLOGICALUTIL_EXPORT URIStream
	{
	public:
	...
	//--------------------------------------------------------------------
		 ...
		 */
	class GWGEOLOGICALUTIL_EXPORT URI
	{
	public:
		/**
	...
	public: // get methods call the read* methods, then just return the raw data.
		...
		osg::Object* getObject(
			const osgDB::Options* dbOptions = 0L,
			ProgressCallback*     progress = 0L) const {
			return readObject(dbOptions, progress).releaseObject();
		}

		osg::Image* getImage(
			const osgDB::Options* dbOptions = 0L,
			ProgressCallback*     progress = 0L) const {
			return readImage(dbOptions, progress).releaseImage();
		}

		osg::Node* getNode(
			const osgDB::Options* dbOptions = 0L,
			ProgressCallback*     progress = 0L) const {
			return readNode(dbOptions, progress).releaseNode();
		}

		std::string getString(
			const osgDB::Options* dbOptions = 0L,
			ProgressCallback*     progress = 0L) const {
			return readString(dbOptions, progress).getString();
		}
	...
	//------------------------------------------------------------------------
		 ...
		 */
	class GWGEOLOGICALUTIL_EXPORT URIAliasMap
	{
	public:
		/**
	 ...
	 */
	class GWGEOLOGICALUTIL_EXPORT URIAliasMapReadCallback : public osgDB::ReadFileCallback
	{
	public:
