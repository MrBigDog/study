...
public:
	...
	//void onGeologicalProfileLayerAdded(LayerProfile* layer);
	//void onGeologicalProfileLayerRemoved(LayerProfile* layer);
	//osg::Node* getGeologicalProfileLayerNode(LayerProfile* layer);
