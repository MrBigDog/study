...
const std::string SL_SAMPLER = "samplerRect";
const std::string SL_TEXTURE = "textureRect";
...
static std::string mrtVertSource = {
...
static std::string mrtFragSource = {
...
static std::string finalVertSource = {
	"void main(void)\n"
	"{\n"
	"   gl_Position = ftransform();\n"
	"   gl_TexCoord[0] = gl_MultiTexCoord0;\n"
...
static std::string finalFragSource = {
...
int main(int argc, char** argv)
{
	...
	if (!scene) scene = osgDB::readNodeFile("C:/COMMON_LIBRARY/3rdparty/share/osgWorks/data/teapot.osg");
