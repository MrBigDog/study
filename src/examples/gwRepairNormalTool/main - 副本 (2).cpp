...
//{
//public:
//	GeometryVisitor(unsigned int vertexNum)
...
//	}
//
//	osg::Geometry* getGeom() { return _geom.get(); }
//
//private:
...
//{
//public:
//	NormalVisitor(osg::Node* node, const osg::Vec4& color, osg::Image* image)
//		: osg::NodeVisitor(osg::NodeVisitor::TRAVERSE_ALL_CHILDREN)
//		, _refNode(node)
//		, _color(color)
//		, _image(image)
...
//
//			//osg::Vec3Array* va = dynamic_cast<osg::Vec3Array*>(geom->getVertexArray());
//			//GeometryVisitor gv(va->size());
//			//_refNode->accept(gv);
//
//			//osg::Geometry* refGeom = gv.getGeom();
//			//if (refGeom)
//			//{
//			//	osg::Matrixd matrix = osg::Matrixd::translate(osg::Vec3d(-412000.0, -3369000.0, -400.0));
//			//	osg::ref_ptr < osg::TexMat> texMat = new osg::TexMat((matrix));
//			//	geom->setTexCoordArray(0, refGeom->getTexCoordArray(0));
//			//	geom->getOrCreateStateSet()->setTextureAttributeAndModes(0, _tex);
//			//	geom->getOrCreateStateSet()->setTextureAttribute(0, texMat);
//			//}
//
//			geom->setUserData(_image);
//
...
int main()
{
	...
	scene->addChild(osgDB::readNodeFile("E:/Received File/BigDog/RayWang/OpenSceneGraph.3.Cookbook/cookbook/data/teapot.osg"));
	...
	hudCamera->addChild(createScreenQuad(0.5f, 1.0f, TEXCOORD_SCALE));
